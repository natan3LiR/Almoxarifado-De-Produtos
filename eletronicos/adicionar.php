    ...
    <div class="card">
        ...
        <form action="createPHP.php" method="post">
            <div class= "form.container">
                ...
                <!--"pattern" Faz com que só aceite caracteres no nome do produto e na descrição-->
                <input type="text" id="desc" name="desc" pattern="[A-Za-zÀ-ú\s]+" required title="Apenas caracteres são permitidos">
                <br>
                <br>
